...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "Public/Admin/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "Public/Admin/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "Public/Admin/assets/images/logo2.png");
					break;

				default:
					$(".navbar-brand img").attr("src", "Public/Admin/assets/images/logo.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "Public/Admin/assets/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "Public/Admin/assets/images/logo.png");
