	...
	public function login($username = '', $password = '', $verify = ''){
			...
			if(0 < $uid){ //UC登录成功
				...
				$this->error($error);
                        ...
                        $bg_info=D('DesignerLoginPic')->find(1);
                        if($bg_info['pic_big']){
                            $this->pic_big_url=  getImgUrl($bg_info['pic_big']);
                        }else{
                            $this->pic_big_url=  '/Public/Home/images/bg.jpg';
                        }
                        if($bg_info['pic_small']){
                            $this->pic_small_url=  getImgUrl($bg_info['pic_small']);
                        }else{
                            $this->pic_small_url=  '/Public/Home/images/log_bg.png';
                        }
			$this->display();
		}
	}
