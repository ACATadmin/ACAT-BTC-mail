...
class BasePayment extends Model{
	...
	public function getOrderSnValue(){
		return ($_POST[ $this->order_sn_name ])?$_POST[ $this->order_sn_name ]:$_GET[ $this->order_sn_name ];
	}
	...
	public function getPayCode_Mobile( $order ){
		return $this->getPayCode( $order );	//默认调用PC端的支付	
	}
	 ...
	 * @param unknown $oInfo
	 */
	public function local_pay($oInfo){

		return 'local_pay_api is not develop...';
	}
