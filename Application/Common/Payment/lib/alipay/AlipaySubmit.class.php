...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp,$jump_url='') {
		...
		$sHtml = "<meta http-equiv='content-type' content='text/html; charset=".$this->alipay_config['input_charset']."'>";
		...
		echo $sHtml = $sHtml."<script>document.forms['alipaysubmit'].submit();</script>";exit;
		return $sHtml;
	}
